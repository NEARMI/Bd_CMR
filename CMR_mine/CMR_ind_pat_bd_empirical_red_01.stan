...
model {
	...
	// Also, struggling a bit to think about how to better separate process and observation uncertainty, especially with so few observations of bd.
	 // the latent variable needs to be on the left

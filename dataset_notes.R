...
print(paste("Dataset has -", length(which(!is.na(data.sum$len))), "- total individuals with -length- measured", sep = " "))
print(paste("Dataset has -", length(which(!is.na(data.sum$mehg))), "- total individuals with -MeHg- measured", sep = " "))
print("-------------------------")

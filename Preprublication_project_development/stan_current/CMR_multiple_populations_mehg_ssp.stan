...
// -----
  ...
  // fixed
	...
	real beta_offseason_mehg_bd;		 	 // interaction term
...
beta_offseason_mehg * ind_mehg_scaled[ind_occ_min1_rep[phi_off_index]]                            + 
...
(beta_offseason_mehg_bd + offseason_pop_mehg_bd[pop_phi[phi_off_index]]) .* ind_mehg_scaled[ind_occ_min1_rep[phi_off_index]] .* X[phi_bd_index[phi_off_index]]
);
